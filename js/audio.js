...
const AudioManager = (function() {
  ...
  function playSnippet(soundKey, start, duration, volume = 0.18, fadeIn = 2500) {
    ...
    try {
      const sound = new Howl({
        src: [`assets/audio/${soundKey}.mp3`],
        sprite: { snippet: [start, duration, false] }, // لا تكرار
        volume: 0,
        preload: true,
      });
      currentId = sound.play('snippet');
  ...
  // المقطع الواحد الطويل من 0:18 إلى 2:45 (147 ثانية)
  function playThreshold() {
    playSnippet('threshold', 18000, 147000, 0.18, 2500);
  }
  ...
  return { play, playSnippet, playThreshold, stop, fadeOut, crossfadeTo };
})();